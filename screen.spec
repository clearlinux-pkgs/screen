...
Source0  : https://mirrors.kernel.org/gnu/screen/screen-4.9.1.tar.gz
Source1  : https://mirrors.kernel.org/gnu/screen/screen-4.9.1.tar.gz.sig
...
%prep
%setup -q -n screen-4.9.1
cd %{_builddir}/screen-4.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692313956
