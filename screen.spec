...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643763592
...
cp %{_builddir}/screen-4.9.0/COPYING %{buildroot}/usr/share/package-licenses/screen/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
